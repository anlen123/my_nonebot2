...
nonebot.load_plugin("plugins.nonebot_plugin_command")
nonebot.load_plugin("plugins.nonebot_plugin_masterduel")
nonebot.load_plugin("plugins.nonebot_plugin_setu")
nonebot.load_plugin("plugins.nonebot_plugin_xuanran")
nonebot.load_plugin("plugins.nonebot_plugin_sendimg")
