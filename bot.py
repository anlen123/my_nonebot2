...
# nonebot.load_plugin('nonebot_plugin_fishing')

nonebot.load_plugin("plugins.nonebot_plugin_love")
nonebot.load_plugin("plugins.nonebot_plugin_pixiv.nonebot_plugin_pixiv")

nonebot.load_plugin("plugins.nonebot_plugin_sbbot")
# nonebot.load_plugin("plugins.nonebot_plugin_deepseek_gpt")
...
# nonebot.load_plugin(
#     "plugins.nonebot-plugin-terralink.nonebot_plugin_terralink")
...
nonebot.load_plugin("plugins.nonebot_plugin_bilibili_live")
nonebot.load_plugin("plugins.nonebot_plugin_bilibili_video")
nonebot.load_plugin("plugins.nonebot_plugin_auto_message")
nonebot.load_plugin("plugins.nonebot_plugin_bazaardb")
nonebot.load_plugin("plugins.nonebot_plugin_repeater")
nonebot.load_plugin("plugins.nonebot_plugin_welcome")
nonebot.load_plugin("plugins.nonebot_plugin_keyword_image")
